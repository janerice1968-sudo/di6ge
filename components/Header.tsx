    ...
    <header className={`fixed top-0 w-full z-50 transition-all duration-500 ${scrolled ? 'py-4 glass-morphism border-b shadow-sm' : 'py-8 bg-transparent'}`}>
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center space-x-10 text-[11px] font-bold tracking-[0.2em] uppercase text-zinc-600">
          <a href="#live" className="hover:text-rose-600 transition-colors">Private View</a>
          <a href="#dating" className="hover:text-rose-600 transition-colors">Encounters</a>
          <a href="#premium" className="hover:text-rose-600 transition-colors">The Experience</a>
          <a href="#privacy" className="hover:text-rose-600 transition-colors">Discretion</a>
        </nav>

        <div className="flex items-center space-x-6">
          <button className="hidden sm:block text-[11px] font-bold tracking-widest text-zinc-900 hover:text-rose-600 transition-colors uppercase">Enter Vault</button>
